...
| macOS Catalina | سطح المكتب | إصدار سابق موثوق | [تحميل](https://apps.apple.com/app/macos-catalina/id1466841314) |
| macOS Mojave | سطح المكتب | إصدار قديم مدعوم | [تحميل](https://apps.apple.com/app/macos-mojave/id1398502828) |
---
## 🌟 نسخ مجتمعية ومتخصصة
| الاسم | النوع | الوصف | رابط التحميل |
|-------|--------|--------|---------------|
...
| Kali Purple | أمني/تطوير | للأمن الدفاعي والتطوير | [تحميل](https://www.kali.org/get-kali/) |
| Ubuntu MATE | سطح المكتب | واجهة MATE الكلاسيكية | [تحميل](https://ubuntu-mate.org/download/) |
| Kubuntu | سطح المكتب | Ubuntu مع بيئة KDE | [تحميل](https://kubuntu.org/getkubuntu/) |
| Xubuntu | سطح المكتب | Ubuntu خفيف مع XFCE | [تحميل](https://xubuntu.org/download/) |
---
